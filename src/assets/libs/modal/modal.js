export default class Modal {
        ...
        if (this.modal) {
            document.addEventListener('click', function (event) {
                ...
                if (clickedElement) {
                    ...
                    if (document.querySelector(`[data-modal-target="${path}"]`)) {
    ...
    open() {
        ...
        const animationName = ['fadeIn', 'fadeInUp', 'fadeInDown', 'fadeInLeft', 'fadeInRight'];
        const animationShow = animationName[Math.floor(Math.random() * animationName.length)];
    ...
    widthElement() {
        // if(this.modalItem.style.width == undefined) {}
